...
class _ChatDetailScreenState extends State<ChatDetailScreen> {
  ...
  _sendMsg() async {
    ...
    lastMsgTime = DateTime.fromMicrosecondsSinceEpoch(
        ...
        .toLocal();
    CommonFunctions.createNotification(widget.uid,
        'New Message from ${StaticInfo.currentUser.name}', message.msgBody);
    setState(() {
      msgCon.clear();
    });
