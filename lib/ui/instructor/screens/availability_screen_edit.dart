...
class AvailabilityScreenEdit extends StatefulWidget {
  @override
  _AvailabilityScreenEditState createState() => _AvailabilityScreenEditState();
}

class _AvailabilityScreenEditState extends State<AvailabilityScreenEdit> {
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  CustomButtonTwo(
                                    text: 'NO',
                                    width: mediaQuery.width * 0.6 * 1.75 / 3,
  ...
  Widget buildTimeString(DateTime time, String string) {
    ...
    // final min = time.minute.toString();
    // final retString = hour + " : " + min;
