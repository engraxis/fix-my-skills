...
class VideoPlayerScreen extends StatefulWidget {
  final Video video;
  final bool playAnalysed;
  final bool playUpdated;
  VideoPlayerScreen({
    @required this.video,
    this.playAnalysed = false,
    this.playUpdated = false,
  });
  @override
...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
  ...
  void didChangeDependencies() async {
    if (_isRunningOnce) {
      ...
      if (widget.playUpdated)
        _videoPlayerController =
            VideoPlayerController.network(widget.video.updatedVideoUrl);
      else if (widget.playAnalysed)
        _videoPlayerController =
